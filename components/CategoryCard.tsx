...
export default function CategoryCard({title, imageUrl}: AppProps ) {
  ...
  return (
    <div className='min-w-[30%] h-[240px] flex-auto flex items-center justify-center border-solid border-black border mx-[7.5px] mt-0 mb-[15px] overflow-hidden hover:cursor-pointer first:mr-[7.5px] last:m-[7.5px] group'>
